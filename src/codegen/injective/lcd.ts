...
export const createLCDClient = async ({
  ...
  return {
    ...
    injective: {
      ...
      exchange: {
        v1beta1: new (await import("./exchange/v1beta1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      insurance: {
        v1beta1: new (await import("./insurance/v1beta1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      ocr: {
        v1beta1: new (await import("./ocr/v1beta1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      oracle: {
      ...
      peggy: {
        v1: new (await import("./peggy/v1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      wasmx: {
        v1: new (await import("./wasmx/v1/query.lcd")).LCDQueryClient({
          requestClient
        })
      }
    }
